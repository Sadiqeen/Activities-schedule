...
<body class="hold-transition skin-blue sidebar-mini fixed">
  <div class="wrapper">
            ...
            <div class="box">
              ...
              <div class="row">
                  ...
                  <div class="col-md-2 form-group">
                    <button class="btn btn-block btn-warning" onclick="$('#modal-adduser').modal('show');">Add User</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <?php require "./sub_admin_user/modal_add_user.php" ?>
    <?php require "./sub_admin_user/modal_dluser.php" ?>
