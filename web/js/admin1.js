$(document).ready(function () {
    ...
    $('#fc').on('change', function() {
        $('#activities-table').DataTable().ajax.url("./php/sub_admin_table_acti.1.php/?fc="+ $('#fc option:selected').val() + "&dp=" + $('#dp option:selected').val()).load();
    });
  ...
  function activities_table() {
    $('#activities-table').DataTable( {
        ...
        "responsive": true,
        "retrieve": true,
        "ajax": "./php/sub_admin_table_acti.1.php/?fc="+ $('#fc option:selected').val() + "&dp=" + $('#dp option:selected').val(),
    } );
  }
