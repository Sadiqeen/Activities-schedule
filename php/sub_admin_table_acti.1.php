<?php
  ...
  $columns = array(
        ...
        array( 'db' => '`a`.`approve`',                'dt' => 6,  'formatter' => function( $d, $row ) {
                    if ($d == 1) {
                        return "Approved";
                    } else if ($d == 0) {
                        return "Waiting";
        ...
        array( 'db' => '`a`.`name`',            'dt' => 7, 'formatter' => function( $d, $row ) {
          return '
